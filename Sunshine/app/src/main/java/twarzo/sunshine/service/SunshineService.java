package twarzo.sunshine.service;
...
import twarzo.sunshine.WeatherContract;

/**
 * Created by quikr on 20/8/15.
 */
    ...
    private void getWeatherDataFromJson(String forecastJsonStr,
        ...
        try {
            ...
            if ( cVVector.size() > 0 ) {
                ...
                getBaseContext().getContentResolver().bulkInsert(WeatherContract.WeatherEntry.CONTENT_URI, cvArray);
            }
