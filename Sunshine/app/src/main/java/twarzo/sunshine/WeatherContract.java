...
public class WeatherContract {
    ...
    // device
    public static final String CONTENT_AUTHORITY = "com.twarzo.sunshine.app";
    ...
    public static String normalizeDate(String startDate) {
        // normalize the start date to the beginning of the (UTC) day
        Time time = new Time();
        Long d = Long.valueOf(startDate);
        time.set(d);
        int julianDay = Time.getJulianDay(d, time.gmtoff);
        d = time.setJulianDay(julianDay);
        String returnDate = String.valueOf(d);
        return returnDate;
    }
    ...
    public static final class WeatherEntry implements BaseColumns {
        ...
        public static Uri buildWeatherLocationWithStartDate(
            ...
            String normalizedDate = normalizeDate(startDate);

            return CONTENT_URI.buildUpon().appendPath(locationSetting)
                    .appendQueryParameter(COLUMN_DATETEXT, normalizedDate).build();
        }
